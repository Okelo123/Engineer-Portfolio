...
export default function Navbar({ isDark, onToggleTheme, onToggleEditor, onToggleMobile, mobileOpen }) {
  return (
    <nav className="nav-main">
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '0 1.5rem', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: 64 }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
          <button onClick={onToggleEditor} className="btn-secondary" style={{ padding: '0.4rem 1rem', fontSize: '0.8rem' }}>
            <Pencil size={16} /> Edit
          </button>
